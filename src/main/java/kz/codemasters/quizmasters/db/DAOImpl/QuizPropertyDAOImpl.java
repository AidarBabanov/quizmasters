...
import kz.codemasters.quizmasters.db.DAO.QuizPropertyDAO;
 ...
 */
public class QuizPropertyDAOImpl implements QuizPropertyDAO {

    EntityManager entityManager;
    public QuizPropertyDAOImpl(EntityManager entityManager){
